...
$cmd = 'set NODE_ENV=local&& set PREFER_PROCESS_ENV=1&& set PORT=60002&& set OSSURL=http://127.0.0.1:60002/&& set DB_PATH=C:\Users\viaco\AppData\Roaming\Electron\db.sqlite&& set UPLOAD_DIR=C:\Users\viaco\AppData\Roaming\Electron\uploads&& node_modules\.bin\tsx.cmd src/app.ts'
