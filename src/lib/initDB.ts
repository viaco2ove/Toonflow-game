...

    {
      ...
      initData: async (knex) => {
        await knex("t_textModel").insert([
          ...
          { manufacturer: "volcengine", model: "doubao-seed-2-0-lite-260215", responseFormat: "schema", image: 1, think: 1, tool: 1 },
          { manufacturer: "volcengine", model: "doubao-seed-2-0-mini-260215", responseFormat: "schema", image: 1, think: 1, tool: 1 },
