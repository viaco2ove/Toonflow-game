...
6. 第 4 条和第 5 条必须是**进度推进型**选项：明确推进任务阶段、引入新线索、或把任务状态切换到下一阶段。
   例如：
   {"role": "旁白", "motive": "任务进度推进：发现楼梯间的暗门"}
   {"role": "旁白", "motive": "任务阶段切换：从打听消息升级到潜入调查"}
   {"role": "旁白", "motive": "任务时间推进：已到约定的汇合时间"}
