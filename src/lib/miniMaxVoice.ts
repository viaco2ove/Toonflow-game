...
export const MINIMAX_VOICE_ID_DEF = `male-qn-qingse`;
export const MINIMAX_VOICE_ID_MALE = `male-qn-qingse`;
export const MINIMAX_VOICE_ID_FEMALE = `female-shaonv`;
...
export async function synthesizeMiniMaxTtsBuffer(options: MiniMaxTtsOptions): Promise<MiniMaxTtsResult> {
  ...
  const payload: Record<string, any> = {
    ...
    stream,
    voice_setting: {
      voice_id: voiceId || MINIMAX_VOICE_ID_DEF,
      speed,
      vol,
      pitch,
    },
